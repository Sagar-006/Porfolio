    ...
    <Container className=" p-0 flex flex-col  gap-y-4 pt-2 text-lg">
      ...
      <div className=" flex justify-around gap-x-0 ">
        {links.map((l, index) => (
          <div
            key={index}
            className="  bg-white  text-black dark:bg-black dark:text-white border-gray-200 dark:border-gray-800   w-[58px] flex items-center justify-center p-2 border rounded-md "
          >
